...
export default function Cabin({ cabin, newImg }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[3fr_4fr] gap-10 md:gap-20 border border-primary-800 py-3 px-6 sm:px-10 mb-12 md:mb-24">
      ...
      <div>
        <h3 className="text-accent-100 font-black text-2xl sm:text-4xl  mb-2 translate-x-0 md:translate-x-[-254px] bg-primary-950 p-2 md:p-6 w-full ">
          Cabin {name}
        </h3>

        <p className="text-sm sm:text-lg text-primary-300 mb-6 md:mb-10">
